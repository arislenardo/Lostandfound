...
1. **Download APK**: [📲 Download app-debug.apk]([https://github.com/arislenardo/Lostandfound/releases/download/alpha/app-debug.apk](https://github.com/arislenardo/Lostandfound/releases/download/beta_v2/app-debug.apk)) 
